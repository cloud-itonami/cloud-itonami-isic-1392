# Business Model: Manufacture of made-up textile articles, except apparel
...
## Classification
- Repository: `cloud-itonami-isic-1392` ([github.com/cloud-itonami/cloud-itonami-isic-1392](https://github.com/cloud-itonami/cloud-itonami-isic-1392))
- ISIC Rev.5: `1392` — Manufacture of made-up textile articles, except apparel
- Domain: `:made-up-textile-articles/plant-operations`
- Social impact: :worker-safety :equipment-safety :product-quality-assurance
- Actor: `:made-up-textile-articles-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :made-up-textile-articles/plant-operations — who wants
...
One managed tenant (:made-up-textile-articles/plant-operations):
...
- Do not bypass the `:made-up-textile-articles-operations-governor` for production decisions.
