# Operator Quickstart — Manufacture of made-up textile articles, except apparel

Shortest path from clone to a verified local dry-run for **ISIC 1392** (`cloud-itonami-isic-1392`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1392.git
cd cloud-itonami-isic-1392
```
...
- Blueprint governor key: `made-up-textile-articles-operations-governor`
- Likely source path: `madeuptextileops.governor.cljc`
