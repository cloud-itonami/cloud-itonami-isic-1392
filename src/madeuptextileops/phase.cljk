(ns madeuptextileops.phase
  "Phase 0->3 staged rollout for the made-up-textile-articles plant-
  ...
  consequence (a cutting/sewing/hemming/quilting-line maintenance
  window means production downtime, and the equipment ends up actually
  touched); it is always a human plant supervisor's call.
  `madeuptextileops.governor`'s `line-operate-blocked-violations` HARD-
...
(defn verdict->disposition
  "Map a Made-Up Textile Articles Operations Governor verdict to a base
